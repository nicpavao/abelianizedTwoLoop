...
\begin{center}
\textit{1. Perturbative calculations in NLSM and DBIVA effective field theories are in many ways significantly simpler than the typical multi-loop calculations of more phenomenological theories, like quantum-chromodynamics (QCD). }
\end{center}
...
\begin{center} \textit{2. Very little is known about the duality between color and kinematics at the multi-loop level for generic models in the web of theories \cite{BCJreview}. 
}
\end{center}
...
\begin{center}
\textit{3.  Finally, the physical properties of DBIVA effective field theories touch a wide range research areas at the forefront of high energy physics.}
\end{center}
