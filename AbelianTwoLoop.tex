...
\item \textbf{Projection}: Project $D$-dimensional tensor structures along defined 4D spinor helicity states using the conventions of \cite{jjmcTASI2014}. This will elucidate where anomalous matrix elements appear for non-supersymmetric DBIVA, which has a classical conserved $U(1)$ symmetry. 
\end{itemize}
