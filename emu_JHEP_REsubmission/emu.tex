...
\begin{align}
\mathcal{H}^{(ijkl)} &= \frac{1}{(\alpha-1)^2(\alpha+1)} = \alpha^0+\alpha^2+\alpha^3+\alpha^4+\alpha^5+2\alpha^6+\alpha^7+2\alpha^8+\cdots
\\
\mathcal{H}^{(ij)(kl)} &= \frac{1}{(\alpha-1)^2(\alpha+1)(\alpha^2+\alpha+1)} = \alpha^0+\alpha^1+2\alpha^2+2\alpha^3+3\alpha^4+3\alpha^5+\cdots
\end{align}
