...
\end{align}
Carrying out such sYM recycled cut verifications of \eqn{eq:N42bub} and \eqn{eq:N4ostrich} in the case of maximally supersymmetric Yang-Mills in four-dimensions is straightforward -- only one (non-vanishing) diagram contributes to each cut. We provide the details in an appendix which may be of pedagogic interest.
