...
\subsection{NLSM via Even-point Multiloop Unitarity}\label{sec:NLSMU}
...
\paragraph{\textbf{Construction via EMU}} Using the four-point NLSM amplitude defined above, the off-shell bubble integral has a numerator simply given by the bubble's two-particle cut.
